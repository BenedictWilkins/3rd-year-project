...
public enum HouseTypeConstant {
  ...
  /**
   * Note that the values given to each type is the a mean value calculated from
   * a sample data set containing 1 millions entries (KWH per half hour
   ...
   */
  AFFLUENT(0.27798, 0.46668), COMFORTABLE(0.26464, 0.27996), ADVERSITY(0.17629,
      0.30267);
